...
export function exampleDocuments(): DocumentRecord[] {
  const base = {
    ...
    createdAt: '2025-09-08T14:32:00+08:00',
    modifiedAt: '2025-09-08T15:20:00+08:00',
    openedAt: '2025-09-08T15:20:00+08:00',
    dirty: false,
  }
  return [
    {
    ...
    },
    {
      ...
      name: '产品规划.docx',
      kind: 'word',
      path: '文档 / 产品 / 产品规划.docx',
      content: word,
      text: '产品规划与设计方案 项目概述 核心体验 里程碑 下一步 统一管理 Markdown PDF Word',
      size: 18432,
      pages: 2,
      tags: ['产品', '规划'],
      favorite: true,
    },
    {
      ...
      name: '每周设计回顾.md',
      kind: 'markdown',
      path: '文档 / 会议 / 每周设计回顾.md',
      content:
        '# 每周设计回顾\n\n> 让每一个细节，都服务于内容。\n\n## 本周进展\n\n完成文档工作台的交互方案，统一编辑与阅读体验。\n\n## 待办事项\n\n- [x] 确定设计系统\n- [x] 整理文档布局\n- [ ] 验证多文档分屏体验\n- [ ] 补充深色主题\n\n## 讨论记录\n\n| 议题 | 结论 |\n| --- | --- |\n| 工具栏 | 保持克制，按文档类型显示 |\n| Inspector | 默认收起，按需查看 |\n| 工作区 | 自动恢复上次打开的文档 |\n',
      text: '每周设计回顾 本周进展 待办事项 讨论记录 工作区 深色主题',
      size: 862,
      tags: ['会议'],
      favorite: false,
    },
